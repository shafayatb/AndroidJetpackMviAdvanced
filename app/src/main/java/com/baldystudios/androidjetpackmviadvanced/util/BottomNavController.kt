...
import com.baldystudios.androidjetpackmviadvanced.fragments.main.blog.BlogNavHostFragment
import com.baldystudios.androidjetpackmviadvanced.fragments.main.create_blog.CreateBlogNavHostFragment
import com.baldystudios.androidjetpackmviadvanced.util.BottomNavController.OnNavigationReselectedListener
...
const val BOTTOM_NAV_BACKSTACK_KEY =
    "com.baldystudios.androidjetpackmviadvanced.util.BottomNavController.BackStack"
...
class BottomNavController(
    ...
    private fun createNavHost(menuItemId: Int) =
        when (menuItemId) {
            ...
            R.id.menu_nav_blog -> BlogNavHostFragment.create(R.navigation.nav_blog)

            R.id.menu_nav_create_blog -> CreateBlogNavHostFragment.create(R.navigation.nav_create_blog)
